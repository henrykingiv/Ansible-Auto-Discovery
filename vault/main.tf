...
#   vpc_id            = var.vpc
#   cidr_block        = var.pub-subnet1-cidr_block
#   availability_zone = var.avb-zone-a
#   tags = {
#     Name = "${local.name}-publicsn1-vault"
#   }
# }
...
#   }
#   tags = {
#     Name = "${local.name}-rt-vault" #tag of first public route table
#   }
# }
...
#   }
#   tags = {
#     Name = "${local.name}-pvrt-vault" #tag of first public route table
#   }
# }
